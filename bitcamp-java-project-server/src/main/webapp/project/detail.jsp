...
<body>
	...
	<form action='update' method='post'>
		...
		내용:
		<textarea name='content' rows='10' cols='70'>${project.content}</textarea>
		<br> 기간: <input type='date' name='startDate'
			value='${project.startDate}'> ~ <input type='date'
			name='endDate' value='${project.endDate}'><br>
		관리자: ${project.owner.name}<br> 팀원: * 는 비활성 상태의 멤버<br>
